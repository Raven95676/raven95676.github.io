...
爷爷/奶奶，各位当年被加密的文件的解密工具出现啦（bushi
...
![[741eeac3c89a4481b4da26f9d52536c3_MD5.png]]
...
![[578e1dd9a9f79b383eef2e43597a0bc2_MD5.png]]
...
1. **投入成本高**：使用NAS进行备份需要一定的硬件投入，包括NAS设备和硬盘的购买。

2. **安全防范意识低的用户可能面临风险**：对于安全意识较低的小白用户，可能会因配置不当而让NAS暴露于勒索病毒的风险中。这些病毒专门针对NAS设备，如果配置不当，可能导致数据丢失或被加密。
